...
interface DeletePoetryModalProps {
  open: boolean;
  title: string;
  isDeleting?: boolean;
  onClose: () => void;
...
export default function DeletePoetryModal({
  open,
  title,
  isDeleting = false,
  onClose,
  onDelete,
}: DeletePoetryModalProps) {
      ...
      {open && (
        ...
        >
          <motion.section
            ...
            aria-describedby="delete-poetry-description"
          ...
          >
            ...
            <p
              id="delete-poetry-description"
              className="mt-3 text-sm leading-6 text-slate-300"
            >
              This will permanently remove{" "}
              <span className="font-semibold text-amber-300 urdu-text">
                {title}
              </span>
